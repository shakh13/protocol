...
export default function GPSSHPS(props) {
    const {control} = props;
            ...
            <Box sx={{marginTop: "15px"}}>
                ...
                >
                    ...
                    >
                        ...
                        <br/>
                        Content of clay in lumps (from the total amount of dust and clay particles in ready-mixed
                        mixtures), %
                    </Grid>
                    <Grid
                        size={2}
