...
} from "./chunk-F72MZIQO.js";
import {
  DialogTitle_default
} from "./chunk-SNW4FV2R.js";
import {
  Dialog_default
...
function Notification({
  ...
  const action = (0, import_jsx_runtime3.jsxs)(React6.Fragment, {
...
function useDialogs() {
  ...
  const alert = React8.useCallback(async (msg, {
    onClose,
    ...options
  } = {}) => open(AlertDialog, {
    ...options,
  ...
  const confirm = React8.useCallback(async (msg, {
    onClose,
    ...options
  } = {}) => open(ConfirmDialog, {
    ...options,
  ...
  const prompt = React8.useCallback(async (msg, {
    onClose,
    ...options
  } = {}) => open(PromptDialog, {
    ...options,
...
var BrandingContext = React12.createContext(null);
var NavigationContext = React12.createContext([]);
var PaletteModeContext = React12.createContext({
  paletteMode: "light",
  setPaletteMode: () => {
  },
  isDualTheme: false
});
var RouterContext = React12.createContext(null);
var WindowContext = React12.createContext(void 0);
...
//# sourceMappingURL=chunk-3ABNOURO.js.map
