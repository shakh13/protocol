...
class OnixShmidt128PDF:
    ...
    def generate(self):
        ...
        TABLE_DATA = [
            ...
            ['Наименование продукции\nProduct name', 'Фундаментные блоки стеновые'],
            ...
            ['НД на методы испытаний\nRD on testing methods', 'ГОСТ 18105-2018, ГОСТ 22690-2015'],
        ...
        TABLE_DATA = [
            ...
            ['Измеритель прочности материалов ОНИКС-1 ОС 050', '4593.MIN.203', '07.06.2024'],
            ['Молоток Шмидта', '55968031', '13.05.2024'],
            ['Психрометр аспирационный', '1111030-2024', '16.05.2024'],
        ]
        ...
        TABLE_DATA = [
            [
                ...
                'Дата бетонирования\nDate of concreting',
                'Дата испытания, сут.\nDate of test, day',
                'Фактическая прочность при сжатии\nActual compressive strength,\nМРа',
