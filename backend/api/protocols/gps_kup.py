...
class GPSKupPDF:
    ...
    def generate(self):
        ...
        TABLE_DATA = [
            ...
            ['Пескозагрузочный аппарат', '87510577', '16.05.2024'],
        ...
        with pdf.table(
                ...
                text_align="L",
                line_height=5,
                col_widths=[10, 38, 25, 23, 20, 20, 20, 21, 21],
                padding=(1, 2, 1, 2)
        ) as table:
            i = 0
            for data in TABLE_DATA:
