...
from api.protocols.generate import generate
...
class Beton08PDF:
        ...
        return {
            ...
            'fields': [
                [
                    ...
                    {
                        'type': 'text',
                        'label': 'Бетонирование монолитного фундамента (А-В/4-8)',
                    },
                    {
                        'type': 'text_field',
                        'name': 'concrete_class_1',
                        'label': '',
                        'adornment': 'Внорм, MPa',
                    },
                    {
    ...
    def generate(self):
        ...
        TABLE_DATA = [
            ['№', 'Наименование продукции\nProduct name', 'Проект. класс бетона\nProject class of concrete\nВнорм, MPa',
             'Дата бетонирования\nDate of concreting',
             'Дата испытания, сут.\nDate of test, day',
             'Фактический класс прочности бетона\nActual strength class of concrete\nВф, МPa',
             'Набрал в % от проектного класса\nScored in % of the project class', 'Выводы\nConclusions'],
            ['1', 'Бетонирование монолитного  фундамента (А-В/4-8)', 'В20', '10.03.2025', '17.03.2025 7 сут', '20,8',
             '104',
             'соот-ет'],
            ['2', 'Бетонирование монолитного  фундамента (А-В/4-8)', 'В20', '10.03.2025', '17.03.2025 7 сут', '20,8',
             '104',
             'соот-ет'],
        ...
        generate(pdf, Beton08PDF.settings(), TABLE_DATA)
        ...
        pdf.set_font("dejavu", "", 9)
        primechanie = 'Фактический класс прочности бетона рассчитывается по схеме Г по ГОСТ 18105-2018 «Бетоны. Правила контроля и оценки прочности».\nThe actual strength class of concrete is calculated according to scheme G according to GOST 18105-2018 «Concrete. Rules for control and strength assessment»'
